(() => {
  ...
  const fields = (prefix = '') => `<div class="b2b-fields">
    ...
    <label>Denier (D)<input name="${prefix}denierValue" inputmode="decimal" type="text" placeholder="Enter denier"></label>
    ...
    <label>TPM<input name="${prefix}tpmValue" inputmode="decimal" type="text" placeholder="Enter TPM"></label>
